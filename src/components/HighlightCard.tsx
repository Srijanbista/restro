...
const HighlightCard = ({ title, description, icon }: HighlightCardProps) => {
  return (
    <div className="p-8 text-center border-2 border-slate-200 flex flex-col gap-y-6 rounded-lg max-w-xs hover:scale-105 transition-transform duration-300 ease-in-out delay-100">
